...
const User = [
  ...
  {id: 'pyo01', nickname: '표선영', image: '/5Udwvqim.png'},
      ...
      [
        {
          postId: cursor + 1,
          User: User[0],
          content: `${cursor + 1} P.com is so marvelous. I'm gonna buy that.`,
        ...
        },
        {
          postId: cursor + 2,
          User: User[0],
          content: `${cursor + 2} P.com is so marvelous. I'm gonna buy that.`,
          Images: [
        ...
        },
        {
          postId: cursor + 3,
          User: User[0],
          content: `${cursor + 3} P.com is so marvelous. I'm gonna buy that.`,
          Images: [],
          createdAt: generateDate(),
        },
        {
          postId: cursor + 4,
          User: User[0],
          content: `${cursor + 4} P.com is so marvelous. I'm gonna buy that.`,
          Images: [
            {imageId: 1, link: faker.image.urlLoremFlickr()},
            {imageId: 2, link: faker.image.urlLoremFlickr()},
        ...
        },
        {
          postId: cursor + 5,
          User: User[0],
          content: `${cursor + 5} P.com is so marvelous. I'm gonna buy that.`,
          Images: [
            {imageId: 1, link: faker.image.urlLoremFlickr()},
            {imageId: 2, link: faker.image.urlLoremFlickr()},
            {imageId: 3, link: faker.image.urlLoremFlickr()},
