...
export async function generateMetadata({params}: Props) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://z.nodebird.com${user.image}`, // user 공유시 user image 나오게 설정
          width: 400,
          height: 400,
        },
      ]
...
export default async function Profile({params}: Props) {
  ...
  await queryClient.prefetchQuery({queryKey: ['posts', 'users', username], queryFn: getUserPosts as any })
